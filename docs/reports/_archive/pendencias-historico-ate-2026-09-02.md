# Pendencias — HISTORICO ate 2026-09-02 (cortado do tracker vivo em 03/09)

Tudo aqui esta EXECUTADO ou SUPERADO pela `pendencias.md` §SEQUENCIA ACORDADA (02/09) e pelo handoff 2026-09-02c. Serve para
o "por que" de regras e numeros antigos (MOTOR PURO, TOKENS CURTOS, dissecacoes 28/08, campanhas 1-3, Plano B, auditorias).
Pendencias ainda abertas foram triadas para `pendencias.md` §PENDENCIAS ANTIGAS AINDA ABERTAS.
...
- **ADIADOS COM DADO** (implementar e medir no holdout dos builds P3): prep-trabalho por marco e
  T<n> segmentador (D2-ext) · formula do G1 como confirmacao do D1 + consumo do summary sec0 (A.5)
  · codigo SARC como 2a chave de identidade (D5-ext) · U<n> no card (D3, medir no FR).
