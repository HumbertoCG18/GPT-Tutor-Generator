"""C1 item 1 — reprocess REGISTRADO dos 8 originais com o gerador commitado (regra `exclusivo` exige 2+ tokens).
...
for name in TUTORES:
    ...
    msg = (f"reprocess: CRONOGRAMA_DETALHADO: titulo qualificado em colisao e gravado sem depender de codigo (gerador {GER}, C1 item 2) — "
