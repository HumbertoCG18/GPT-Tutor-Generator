"""C0 item 12: travessia ANTES (tabela fechada 03/09 no tracker; JSONs do HEAD onde batem com a tabela) x DEPOIS (JSONs novos).
...
ANTES = {
    ("FR", "sem-llm"): (9, 11, "5/6", 4, 2, 3), ("FR", "llm"): (15, 15, "6/6", 5, 5, 5), ("FR", "llm-completo"): (15, 15, "6/6", 5, 5, 5),
    ("IA", "sem-llm"): (10, 12, "6/8", 4, 1, 5), ("IA", "llm"): (9, 10, "8/8", 3, 2, 4), ("IA", "llm-completo"): (10, 10, "8/8", 3, 2, 5),
    ("CG", "sem-llm"): (10, 11, "8/11", 4, 3, 3), ("CG", "llm"): (8, 8, "7/11", 2, 3, 3), ("CG", "llm-completo"): (10, 10, "7/11", 2, 4, 4),
}
