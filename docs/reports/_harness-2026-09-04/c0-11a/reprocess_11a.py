"""C0 11a — reprocess REGISTRADO dos 8 originais com o gerador commitado (regra `exclusivo` exige 2+ tokens).
...
for name in TUTORES:
    ...
    msg = (f"reprocess: exclusivo com 1 so token vira flag, voter e card decidem (gerador {GER}, C0 11a) — "
