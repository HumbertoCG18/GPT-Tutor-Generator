"""Propagacao de vocabulario SEM LLM para a subunidade: tokens EXCLUSIVOS dos headings/titulo dos materiais que o
...
print(f"TOTAL conf_min={CONF_MIN} min_entries={MIN_ENTRIES} df_max={DF_MAX}: sub {tot['ok1']}/{tot['n']} -> {tot['ok2']}/{tot['n']}  + {tot['+']}  - {tot['-']}  ~ {tot['~']}")
