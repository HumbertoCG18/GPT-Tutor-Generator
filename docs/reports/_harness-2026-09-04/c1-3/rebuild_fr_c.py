"""RUN C do FR (12/09, user: "uma usando o datalab mas sem LLM"): tutor do ZERO numa COPIA (.ablacao/FR-rebuild-C/Fundamentos-de-Redes-Tutor),
...
REPO = GEN / ".ablacao" / "FR-rebuild-C" / "Fundamentos-de-Redes-Tutor"
...
print("\n=== rebuild (run C, Datalab sem LLM) x produto (vocab LLM + voter + resumos) ===")
