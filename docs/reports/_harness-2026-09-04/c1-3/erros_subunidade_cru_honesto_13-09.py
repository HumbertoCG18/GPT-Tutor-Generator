"""Os erros de SUBUNIDADE no motor COMPLETO, regime cru HONESTO (13/09: copia no braco C, sem a curadoria escolhida pelo placar; base 142/251) — o insumo do ataque a subunidade.
...
out = Path(__file__).resolve().parent / "erros_subunidade_cru_honesto_13-09.csv"
