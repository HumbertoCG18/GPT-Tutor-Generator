"""[WEAK-ONLY: 2a passada so onde a 1a nao decidiu com confianca] Propagacao de vocabulario SEM LLM para a subunidade: tokens EXCLUSIVOS dos headings/titulo dos materiais que o
