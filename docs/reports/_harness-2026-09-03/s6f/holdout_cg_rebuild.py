...
GOLD = Path(r"C:/Users/Humberto/AppData/Local/Temp/claude/C--Users-Humberto-Documents-GitHub-GPT-Tutor-Generator/fa121614-7a37-4f0e-a71b-7c8ccb52f2b4/scratchpad/ground_truth_CG.rebuild.csv")
...
t0 = time.time()
if not NOSYNC:
    ab.sync(Path(r"C:/Users/Humberto/Documents/GitHub/GPT-Tutor-Generator/.ablacao/CG-rebuild") / REPO, dst)
    if not CURADO:
