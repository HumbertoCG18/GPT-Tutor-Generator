# Plano de Ensino — Inteligência Artificial (texto integral do perfil)

ESCOLA: Politécnica

DISCIPLINA: Inteligência Artificial

CÓDIGO: 98708-04 CRÉDITOS: 04 SEMESTRE: 2026/01

CARGA HORÁRIA: Total: 60 hs (x ) Presencial ( ) On-line ( ) Extensionista

CARGA HORÁRIA DE TRABALHO DISCENTE EFETIVO: Total: a definir

PROFESSOR: Silvia Moraes    silvia.moraes@pucrs.br

EMENTA:
Estudo teórico-prático das diversas abordagens de formalização e resolução de problemas utilizando algoritmos de inteligência artificial. Estudo teórico-prático de uso de algoritmos de busca para resolução de problemas em agentes autônomos. Apresentação de abordagens para representação de conhecimento. Apresentação de técnicas de geração automática de planos. Introdução ao Aprendizado de Máquina.
...
G1 = 0,4P1 + 0,4P2+ 0,2MT

onde:

P1: Prova 1, abrange o conteúdo visto até a data desta prova.

P2: Prova 2, abrange o conteúdo visto até a data desta prova.
