...
## 7. FILA DE CAMPANHAS
**12/09: C1 TRAVESSIA FECHADA** (Fase 1 no gate: 92,2% e unidade igual a 07/09; Fase 2 fechada; 3.x era C5 pelo plano §4). **C5 DÍVIDAS DE DADOS ABERTA**, ordem aprovada pelo user: (1) 16 contradições material_gt × bloco, planilha `docs/reports/contradicoes_unidade_material_gt_vs_bloco.csv` a adjudicar; (2) gold de unidade FR e LR; (3) fila do CG; (4) insumo html/vídeo; (5) Matriz de Atribuição. Ruling do u04 do CG mantido; os 9 erros do aglomerado são teto do motor.
