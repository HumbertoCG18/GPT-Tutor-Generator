...
> regra mantida. Fase 3: 3.2 fechado em 11/09 à noite (gold de unidade do CG, 93 materiais, aprovado; produto 84/93). Ver `docs/reports/_archive/2026-09-11-handoff-camada3.md` e `pendencias.md`.
