...
last_updated: 2026-09-12 tarde (PASSO 0 feito + Gate 1 decidido: regua congelada, replay = produto em 251/251, cru 147 aceito/105 primario, **aceito do confiante no cru 59,5% com 82 erros confiantes**; suite 2348 passed, 4 skipped). **PONTO DE ENTRADA =
...
**Leitura:** sem vocab LLM o motor **nao sabe que esta inseguro** — entrega errado sem avisar em 82 dos 190 confiantes (produto: 15 de 193) e a fila pega so 26% dos erros. A cobertura quase nao muda (75,7% x 76,9%): **o que o vocab LLM compra nao e decisao a mais, e decisao CERTA, e com ela a capacidade de abster.** Aceito do confiante no cru por curso: **IA 5/39 = 13%** (39 de 39 confiantes, erra 34 com confianca) · FR 41% · ES2 68% · SO 73% · MF 75% · CG 78% · TCC 80%. Motivos que a fila usa nos erros do cru: `sub-empate` 14, `conflito` 8, `sub-ambigua` 1 — nenhum outro gatilho reage a falta de vocabulario. **Consequencia para o passo 1: o SARC posicional tem que ser medido nas duas pontas, quanto acerta E quanto passa a abster.**
