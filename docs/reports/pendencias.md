...
Instrumento:  (monta por erro o BUNDLE EXATO que o adquiridor receberia + o catalogo completo de topicos) e 13 agentes (7 diagnosticadores + 6 refutadores que so atacam a classe otimista). Auditavel em , 109 linhas. Detalhe no handoff §30.
...
**A DESCOBERTA LATERAL, E VALE MAIS QUE A RESPOSTA PEDIDA — em 23 dos 109 a evidencia decisiva NUNCA CHEGA AO BUNDLE:** CG 11 (o corte em 24 headings esconde o arquivo 26 de 43) · MF 5 ( no frontmatter, campo que o bundle nao le) · FR 4 (os zips dizem  2-5x por arquivo; o bundle so expoe nome de zip) · ES2 3 (,  nos .java) · IA 0. **Nao e falta de vocabulario, e o insumo sendo jogado fora antes do adquiridor ver.**
**ALAVANCAS NOMEADAS, NENHUMA MEDIDA:** (1) engenharia de bundle, 23 materiais, deterministica e sem LLM · (2) ES2: um bug so vale 5 dos 12 ( engolindo material que grita MICROSSERVICOS) · (3) normalizacao x, ~ · (4) CG: o  NAO e pontuado pelo scorer de subunidade · (5) FR: empate 0,1422 x 0,1422 entre irmaos devolve vazio — falta desempate no piso · (6) IA: confianca 1,000 sobre bundle sem token de "aprendizado" = fallback para o 1o topico da unidade.
...
**RESSALVA:** a fronteira C x A foi separada por leitura e e onde eu mais erraria; o proximo passo honesto para as 38 de C e confrontar a classificacao com o score real do topico do gold, que e deterministico e ja esta em .
