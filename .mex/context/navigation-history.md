# Histórico de navegação (snapshot anterior à consolidação #44)

Referência histórica; não carregar no bootstrap nem usar como estado atual.
Regras correntes no ROUTER.md e no workflow canônico prevalecem.
Links do snapshot abaixo foram relativos a .mex/; resolver a partir dessa pasta.
