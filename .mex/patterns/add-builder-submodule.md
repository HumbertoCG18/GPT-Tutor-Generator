...
Reviewed against the current `src/builder` subpackage layout on 2026-06-17.
...
- `src/builder/sources/` — source/repository import helpers and source-specific processing
