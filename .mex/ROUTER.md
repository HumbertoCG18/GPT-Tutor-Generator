...
| Selecionar goal e operar o agente noturno | `docs/reports/goals-noturnos.md` (catálogo) e `.mex/patterns/agente-noturno.md` (contrato); disponibilidade no tracker |
